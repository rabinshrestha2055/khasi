...
public class Productadapter1 extends RecyclerView.Adapter<Productadapter1.ProductViewHolder> {
    ...
    public Productadapter1(Context mCtx, List<Product> productList) {
        this.mCtx = mCtx;
        ...
        holder.textViewPrice.setText("Rs."+(String.valueOf(product.getPrice())));
         ...
         holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
             ...
             public void onClick(View v) {
                 Intent intent =new Intent(mCtx,ChangeActivity.class);
                 intent.putExtra("image", product.getImage());
                 intent.putExtra("eprice",product.getPrice());
                 intent.putExtra("eweight",product.getTextViewWeight());
                 intent.putExtra("ename",product.getName());
                 intent.putExtra("eaddress",product.getAddress());
                 intent.putExtra("etitle",product.getTitle());
                 intent.putExtra("edesc",product.getShortdesc());
